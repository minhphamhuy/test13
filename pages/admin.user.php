            ...
            if (isset($_POST['checkbox'])) {
                ...
                if (sizeof($_POST['checkbox']) > 0) {
                    ...
                    if (isset($_POST['search-customer'])) {
                        if ($username_valid || $first_name_valid || $last_name_valid || $email_valid || $phone_valid) {
            ...
            <div class="column right" style="background-color: #3e3e3e; padding: 20px;">
                <table style="width: 100%; background-color: #565656; border: 2px solid white">
                    <th style="padding: 10px 10px 6px 10px; max-height: 100px;">
                        <h5 class="pull-left" style="color: white; font-weight: bold">Customers (<?php echo $db->numRows(); ?>)</h5>
                    </th>
                </table>
                <p style="padding-top: 5px; color: white; font-size: 15px;">Click on a customer to see more detailed information and actions to perform on them.</p>
                ...
                <div class="container" style="width: 70%; padding-bottom: 20px;">
                    <form action="index.php?p=admin&c=users" method="post" class="search-form">
                        ...
                        ?>
                        <input type="submit" name="search-customer" class="search-btn" value="SEARCH">
                    </form>
                </div>
